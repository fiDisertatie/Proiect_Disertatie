<html>
    ...
    <div class="head_adeverinta">
        <p><strong>Adeverință</strong></p>
    </div>
    <div class="text_adeverinta">
        <p class="text_adeverinta-p">Adeverim prin prezenta că <strong>{{ $teacher->fullNameWithoutInitial() }}</strong> este cadru didatic {{ mb_strtolower($teacher->statut) }} la {{ ucwords(mb_strtolower($teacher->denumire_unitate)) }} pe catedra de {{ ucwords(mb_strtolower($teacher->disciplina_incadrare)) }}.</p>
        <p class="text_adeverinta-p">Eliberăm prezenta pentru a-i servi la {{ $teacher->foloseste_la }}.</p>
    </div>
    <br>
    <br>
    <br>
